export const DISPOSITIONS = [
  { id: "appointment_set", label: "Quote requested", status: "Quote Requested", kpi: "quote_requested" },
  { id: "callback_scheduled", label: "Follow up", status: "Replied", kpi: "callback_scheduled", when: true },
  ...
  { id: "not_interested", label: "Not interested", status: "Load Lost", kpi: "not_interested" },
  { id: "wrong_number", label: "Wrong number", kpi: "wrong_number" },
  { id: "disqualified", label: "Not relevant", status: "Load Lost", kpi: "disqualified" },
  { id: "dnc", label: "Do not contact", kpi: "dnc", dnc: true },
] as const;
