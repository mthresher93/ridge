export const NAV = [
  ...
  { href: "/people", label: "Leads", hint: "03" },
  { href: "/callbacks", label: "Callbacks", hint: "04" },
  ...
  { href: "/numbers", label: "KPI", hint: "10" },
  { href: "/money", label: "Money", hint: "11" },
  { href: "/analytics", label: "Analytics", hint: "12" },
  { href: "/studio", label: "AI Studio", hint: "13" },
